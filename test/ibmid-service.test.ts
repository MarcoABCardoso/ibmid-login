    ...
    describe('#proxy', () => {
        describe('For default services', () => {
            it('Forwards the request to the service URL', (done) => {
                ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id/foo_path", "urlParams": { "resource_id": "foo_resource_id" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
            ...
            it('Forwards the request to the service URL', (done) => {
                ibmidService.proxy({ method: "GET", url: "/api/resources/foo_resource_id/", "urlParams": { "resource_id": "foo_resource_id" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
                            "headers": {},
                            "body": { "credentials": { "url": "foo_service_url" }, "id": "foo_resource_id", "guid": "foo_resource_guid" },
                        })
                        done()
                    })
            })
            it('Forwards the request to the service URL', (done) => {
                ibmidService.proxy({ method: "POST", url: "/api/resources/foo_resource_id/", "urlParams": { "resource_id": "foo_resource_id" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
            ...
            it('Forwards the request to the service URL', (done) => {
                ibmidService.proxy({ method: "GET", url: "/api/resources/foo_resource_id_no_keys/", "urlParams": { "resource_id": "foo_resource_id_no_keys" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
                            "headers": {},
                            "body": { "credentials": {}, "id": "foo_resource_id_no_keys", "guid": "foo_resource_guid_no_keys" },
                        })
                        done()
                    })
            })
            it('Forwards the request to the service URL', (done) => {
                ibmidService.proxy({ method: "GET", url: "/api/resources/foo_resource_id_no_keys_conversation/foo_endpoint", "urlParams": { "resource_id": "foo_resource_id_no_keys_conversation" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
            ...
            describe('When service request fails', () => {
                it('Forwards the error response', (done) => {
                    ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id/foo_path_error", "urlParams": { "resource_id": "foo_resource_id" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                        .catch(err => fail(err))
                        .then(data => {
            ...
            describe('When service is not found', () => {
                it('Responds with RC 404', (done) => {
                    ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id_missing/foo_path", "urlParams": { "resource_id": "foo_resource_id_missing" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                        .catch(err => fail(err))
                        .then(data => {
        ...
        describe('For dashboard services', () => {
            it('Does not include authorization headers in request', (done) => {
                // ibmidService = new ResourceService(jest.fn(x => Promise.resolve(x.url.endsWith('/resource_keys') ? dashboardKeysSuccessResponse : x.url.endsWith('/foo_path') ? proxySuccessResponse : resourceSuccessResponse)), jest.fn(), mockIAMAPI)
                ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id_dashboards/daas/foo_path", "urlParams": { "resource_id": "foo_resource_id_dashboards" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
        ...
        describe('For functions services', () => {
            it('Builds URL from resource', (done) => {
                ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id_functions/foo_path", "urlParams": { "resource_id": "foo_resource_id_functions" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({ "body": { "foo": "data" }, "headers": { "foo": "headers" }, "statusCode": 200 })
                        done()
        ...
        describe('For functions web services', () => {
            it('Builds URL from resource', (done) => {
                ibmidService.proxy({ method: "FOO_METHOD", url: "/api/resources/foo_resource_id_functions/web/foo_path", "urlParams": { "resource_id": "foo_resource_id_functions" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({ "body": { "foo": "data" }, "headers": { "foo": "headers" }, "statusCode": 200 })
                        done()
        ...
        describe('For functions system services', () => {
            it('Builds URL from resource', (done) => {
                ibmidService.proxy({ method: "FOO_METHOD", url: `/api/resources/${encodeURIComponent('crn:v1:bluemix:public:functions:us-south:a/f9aa503dffc94e4cec4f8f104a39ec72:whisk.system::')}/foo_path`, "urlParams": { "resource_id": "crn:v1:bluemix:public:functions:us-south:a/f9aa503dffc94e4cec4f8f104a39ec72:whisk.system::" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({ "body": { "foo": "data" }, "headers": { "foo": "headers" }, "statusCode": 200 })
                        done()
        ...
        describe('For global services', () => {
            describe('When service endpoint is provided', () => {
                it('Builds URL from endpoints response', (done) => {
                    ibmidService.proxy({ method: "FOO_METHOD", url: `/api/resources/foo_resource_id_endpoints/foo_path`, "urlParams": { "resource_id": "foo_resource_id_endpoints" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: { 'x-endpoint-id': 'foo:path:to:endpoint' } })
                        .catch(err => fail(err))
                        .then(data => {
                            expect(data).toEqual({ "body": { "foo": "data" }, "headers": { "foo": "headers" }, "statusCode": 200 })
                            done()
            ...
            describe('When the path is /endpoints', () => {
                it('Returns endpoints', (done) => {
                    ibmidService.proxy({ url: `/api/resources/foo_resource_id_endpoints/endpoints`, "urlParams": { "resource_id": "foo_resource_id_endpoints" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: { 'x-endpoint-id': 'foo:path:to:endpoint' } })
                        .catch(err => fail(err))
                        .then(data => {
                            expect(data).toEqual({ "headers": {}, "body": { "foo": { "path": { "to": { "endpoint": "foo_global_resource_url" } } } }, "statusCode": 200 })
                            done()
                        })
                })
            })
            describe('When no service endpoint is provided', () => {
                it('Returns RC 400', (done) => {
                    ibmidService.proxy({ method: "FOO_METHOD", url: `/api/resources/foo_resource_id_endpoints/foo_path`, "urlParams": { "resource_id": "foo_resource_id_endpoints" }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' }, headers: {} })
                        .catch(err => fail(err))
                        .then(data => {
                            expect(data).toEqual({ "body": { "message": "No service endpoint provided" }, "headers": {}, "statusCode": 400 })
                            done()
                        })
                })
            })
    ...
    describe('#listResources', () => {
        describe('When a query for resource type is passed', () => {
            it('Lists resources of that type', (done) => {
                ibmidService.listResources({ url: "/api/resources", "params": { q: 'foo_catalog_name_1' }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' } })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
        ...
        describe('When no catalog entry is found for query', () => {
            it('Lists resources of that type', (done) => {
                ibmidService.listResources({ url: "/api/resources", "params": { q: 'foo_catalog_name_4' }, "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' } })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 404,
        ...
        describe('When no query for resource type is passed', () => {
            it('Lists all resources', (done) => {
                ibmidService.listResources({ url: "/api/resources", "cookies": { "token": 'foo_token', "refresh_token": 'foo_refresh_token', "account_id": 'foo_account_guid' } })
                    .catch(err => fail(err))
                    .then(data => {
                        expect(data).toEqual({
                            "statusCode": 200,
