...
class AuthenticatedService extends BaseService {
    ...
    constructor(sendRequest, iamApi) {
        super(sendRequest)
        this.iamApi = iamApi
        this.authenticatedFunction = this.authenticatedFunction.bind(this)
    }
    ...
    authenticatedFunction(fn) {
        return async function (options) {
            ...
            if (!options.cookies || !options.cookies.refresh_token)
                return notLoggedInResponse()
            if (!options.cookies.token) {
...
AuthenticatedService.default = new AuthenticatedService(axios, IAMAPI.default)
